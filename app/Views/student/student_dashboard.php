...
<head>
    <meta charset="utf-8">
    <title>Tableau de bord | ExamManager</title>
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="md:flex hidden items-center gap-2.5 text-sm font-semibold">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <a href="/student_dashboard" class="text-sm font-medium text-slate-700 dark:text-slate-400" aria-current="page">Tableau de bord</a>
                        </div>
                    </div>
                </div>
                <!-- Page Title End -->
                                ...
                                <div class="p-6">
                                    <div class="flex justify-between items-start">
                                        <div class="flex">
                                            ...
                                            <div>
                                                <h4 class="text-base mb-1 text-gray-600 dark:text-gray-400">Moyenne générale du cette semestre</h4>
                                ...
                                <div class="p-6">
                                    <div class="flex justify-between items-start">
                                        <div class="flex">
                                            ...
                                            <div>
                                                <h4 class="text-base mb-1 text-gray-600 dark:text-gray-400">Nombre de modules</h4>
                                                <p class="font-normal text-sm text-gray-400 truncate dark:text-gray-500">7</p>
                                            </div>
                                        </div>
                                        <div>
                                            <button class="text-gray-600 dark:text-gray-400" data-fc-type="dropdown" data-fc-placement="left-start" type="button">
