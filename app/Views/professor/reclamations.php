...
<head>
    <meta charset="utf-8">
    <title>Les réclamations | ExamManager</title>
        ...
        <div class="page-content">
            ...
            <main class="flex-grow p-6">
                ...
                <div class="flex justify-between items-center mb-6">
                    <h4 class="text-slate-900 dark:text-slate-200 text-lg font-medium">Les réclamations</h4>
                    ...
                    <div class="md:flex hidden items-center gap-2.5 text-sm font-semibold">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <a href="/professor_reclamations" class="text-sm font-medium text-slate-700 dark:text-slate-400" aria-current="page">Les réclamations</a>
                        </div>
                    </div>
                </div>
                <!-- Page Title End -->
                                    ...
                                    <table class="w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        <thead class="bg-gray-50 dark:bg-gray-700">
                                            <tr>
                                                ...
                                                <th style="width: 236px;" scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase dark:text-gray-400">Actions</th>
                                            </tr>
                                        </thead>
                                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                            <tr>
                                                ...
                                                <td class="px-6 py-4">
                                                    <!-- Show action buttons only if status is "En cours" -->
                                                    <button class="px-4 py-2 btn bg-success text-white">
                                                        Accepter
                                                    </button>
                                                    <button class="px-4 py-2 btn bg-danger text-white">
                                                        Rejeter
                                                    </button>
                                                </td>
                                            </tr>
