                    ...
                    <div class="p-6">
                        <form action="/login" method="post">
                            ...
                            <div class="mb-4 mt-4">
                                ...
                                <input id="LoggingEmailAddress" class="form-input" name="email" type="email" placeholder="Enter your email" value="<?= isset($old) ? esc($old['email']) : '' ?>">
                            </div>
                            ...
                            <p class="text-gray-500 dark:text-gray-400 text-center">Don't have an account ?<a href="/signup" class="text-primary ms-1"><b>Register</b></a></p>
                        </form>
                    </div>
                </div>
            </div>
